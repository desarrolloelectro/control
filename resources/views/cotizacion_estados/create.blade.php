...
if(isset($cotizacion_estado)){
    $nombre = $cotizacion_estado->nombre;
    $color = $cotizacion_estado->color;
    ...
    <div class="col-md-9">
          <div class="tile">
            ...
            <form method="POST" id = "formulario" action="{{ $accion }}">
                ...
                <a href="{{ route('cotizacion_estados.index') }}"><button class="btn btn-success" type = "button">Regresar</button></a>
