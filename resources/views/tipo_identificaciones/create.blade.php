...
if(isset($tipo_identificacion)){
    ...
    $abreviatura = $tipo_identificacion->abreviatura;
    ...
    <div class="col-md-9">
          <div class="tile">
            ...
            <form method="POST" id = "formulario" action="{{ $accion }}">
                ...
                <div class = "row">
                    ...
                    <div class = "col-md-6">
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" name="abreviatura" id="abreviatura" value="{{ old('abreviatura',$abreviatura) }}">
                        </div>
                    </div>
                </div>
                ...
                <a href="{{ route('tipo_identificaciones.index') }}"><button class="btn btn-success" type = "button">Regresar</button></a>
