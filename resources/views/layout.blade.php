  ...
  <!--body class="app sidebar-mini rtl pace-done sidenav-toggled"-->
    ...
    <aside class="app-sidebar">
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item <?php if (isset($controlador) && $controlador == 'cotizaciones') echo 'active';?>" href="{{ route('cotizaciones.index') }}"><i class="app-menu__icon fa fa-list"></i><span class="app-menu__label"> Autorizaciones / <br>Gastos</span></a></li>
        <li><a class="app-menu__item <?php if (isset($controlador) && $controlador == 'informe_ventas') echo 'active';?>" href="{{ route('informe_ventas.index') }}"><i class="app-menu__icon fa fa-book"></i><span class="app-menu__label">Día sin IVA Julio</span></a></li>
        <li><a class="app-menu__item <?php if (isset($controlador) && $controlador == 'dia_ivas') echo 'active';?>" href="{{ route('dia_ivas.index') }}"><i class="app-menu__icon fa fa-book"></i><span class="app-menu__label">Día sin IVA Noviembre</span></a></li>
