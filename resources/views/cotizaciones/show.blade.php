                            ...
                            @isset($cotizacion_detalle)
                                @if ($cotizacion_detalle->isNotEmpty())
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input  <?php if(!$edit_fcoti || $bloq_coti) echo 'readonly'; ?> required type="text" class = "form-control" name = "valor_tabla[]" id = "valor_tabla[]" value = "{{ $detalle->valor }}">
                                        </td>
                                        <td>
                ...
                <div class = "row">
                    <div class = "col-md-12">
                        <div class="form-group">
                            ...
                            ?>
                            <textarea <?php if(!$edit_obs_rev || $bloq_gasto)  echo 'readonly'; ?> name="obs_revisoria" id="obs_revisoria" rows="3" class="form-control">{{ old('obs_revisoria',$obs_revisoria) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class = "row">
                    <div class = "col-md-4">
                        <div class="form-group">
                            ...
                            @if(!$edit_valor || $bloq_gasto)
                                ...
                                @else
                                <input readonly required type = "number" name="valor_autorizado" id="valor_autorizado" class="form-control" value = "{{ old('valor_autorizado',$valor_autorizado) }}">
                                @endif
                            @else
                            <input readonly required type = "number" name="valor_autorizado" id="valor_autorizado" class="form-control" value = "{{ old('valor_autorizado',$valor_autorizado) }}">
                            @endif
                    ...
                    <div class = "col-md-4">
                        <div class="form-group">
                            ...
                            <select disabled class="form-control" name="revisoria_estado_id" id="revisoria_estado_id" aria-required="" aria-required="true" required>
...
<script type="text/javascript">
    ...
    function agregar(){
        ...
        cadena += "<td><input class = 'form-control' required type='text' name='valor[]' value='' /></td>";
