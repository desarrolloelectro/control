        ...
        <input hidden {{ isset($dia_iva) ? ' disabled ' : '' }} type="number" class="dsi_ant_dsm_id form-control" name="dsi_ant_dsm_id[]"  value="{{ isset($dia_iva) && isset($dsi_data_dsms) ? $dsi_data_dsms->id : '' }}">
    <div class="col-md-11">
            ...
            <div class="row justify-content-center">
                <fieldset class="col-12 col-md-12">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4" style="display: block;">
                            <div class="form-group">
                                ...
                                <input required="" required-marked="marked" {{ isset($dia_iva) ? ' disabled ' : '' }} readonly type="text" class="dsi_ant_dsm form-control" name="dsi_ant_dsm[]" value="{{ isset($dia_iva) && isset($dsi_data_dsms) ? $dsi_data_dsms->dsm : $documentdsm }}">           
                            </div>
                        </div>
                        <div class="col-md-4" style="display: block;">
                            <div class="form-group">
                                <label>Número de documento separado mercancía</label> <i class="fa fa-asterisk" style="color:red;font-size:8px;"></i>
                                <input required="" required-marked="marked" {{ isset($dia_iva) ? ' disabled ' : '' }} type="number" class="dsi_ant_num_dsm form-control" name="dsi_ant_num_dsm[]" value="{{ isset($dia_iva) && isset($dsi_data_dsms) ? $dsi_data_dsms->num_dsm : '' }}">            
                            </div>
                        </div>
                    </div>
                    <h2>Productos</h2>
                    <div>
                        ...
                        @include('dsi.data.partials.templetes.addproduct',['ayuda' => $ayuda, 'dsi_data_products' => $dsi_data_products, 'dia_iva' => $dia_iva])
                    </div>
                <?php }
            }
            //dd($dia_iva);
