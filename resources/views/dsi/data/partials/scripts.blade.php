...
function load_saldo_auto(){
            ...
            var contentType = data.headers.get("content-type");
                if(contentType && contentType.indexOf("application/json") !== -1) {
                    ...
                    json.data.forEach(obj => {
                        ...
                        <!--td>
                            <button type="button" onclick="desasociarProductoAnticipo(${id_producto_para_anticipo},${obj.id},'Confirma que desea dejar de utilizar el anticipo de $ ${ custom_currency_format(obj.valor_recibo) } en el producto con referencia ${ref_producto_para_anticipo}?')" class="btn btn-success">Seleccionar</button>
                        </td-->
                        <tr>`;
                    });           
    ...
    function desasociarProductoAnticipo(producto,anticipo,mensaje=""){
        ...
        var loading = document.getElementById('loading');
            ...
            if(contentType && contentType.indexOf("application/json") !== -1) {
                ...
                json.data.forEach(obj => {
                    ...
                    <td><input type="number" min="0" max="${ obj.saldo }" class="valor_anticipo_usar_en_producto" value="0"></td>
